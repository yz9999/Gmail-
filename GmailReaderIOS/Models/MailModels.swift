...
enum MailboxKind: String, CaseIterable, Identifiable, Codable {
...
enum GmailReaderError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .configuration(let message), .keychain(let message), .mail(let message): return message
